...
import img from '../assets/img/hero/guy.png';
...
export default function Hero() {
  return (
    ...
    <p className='mb-6 lg:mb-12 max-w-[480px] lg:text-lg'>Yoga is a way life, rather than a chore. Contrect the stresses of modrn life by becoming more mindful and compassionate.</p>
    ...
    <Parallax className='w-full h-full p-28 lg:p-16' bgImage={img} bgImageAlt='guy image'strength={200} />
    </div>
    </div>
    </div>
    </div>
